...
带漂移项的随机游走模型适合处理[@fig-全球变暖]所展示的全球变暖相关数据。该模型中
...
很多时间序列模型都是假设由固定周期性变化的信号和随机噪声叠加构成的，[@fig-fMRI]说表示的fMRI序列就有很明显的周期性。
...
相关性是时间序列分析的基本特征，所以最常用的描述性度量是用协方差和相关函数表示。
